  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      ...
      <div className="grid grid-cols-2 gap-4 mb-6">
        <div className="card-mac p-4 flex items-center gap-3">
          <div
          ...
          >
            <div
              className={`w-3 h-3 rounded-full ${
                hasGenomeData ? 'bg-green-500' : 'bg-gray-400'
              }`}
            />
          </div>
          <div>
        ...
        <div className="card-mac p-4 flex items-center gap-3">
          ...
          >
            <div
              className={`w-3 h-3 rounded-full ${
                loadedDatabases > 0 ? 'bg-green-500' : 'bg-gray-400'
              }`}
            />
          </div>
          <div>
      ...
      <div className="grid grid-cols-2 gap-4 mb-6">
        {features.map((feature) => (
          <Link
            ...
            className={`card-mac p-4 transition-all ${
              feature.disabled
          ...
          >
            <div
              className={`w-12 h-12 ${feature.color} bg-opacity-20 rounded-xl flex items-center justify-center mb-3`}
            >
      ...
      <div className="bg-green-50 dark:bg-green-900/20 rounded-xl p-4 flex items-start gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-green-700 dark:text-green-500">
            Your genetic data never leaves your device. All processing happens locally on your
            Mac.
          </p>
        </div>
      </div>
